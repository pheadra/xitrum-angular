...
app.controller('ReviewCtrl', ['$scope', 'reviews', '$state', '$stateParams', '$window',
    function($scope,   reviews,   $state,  $stateParams, $window) {


        var applicationkey = $stateParams.review;
        if(applicationkey == null || applicationkey == ''){
            applicationkey = 'moncast';
        }
